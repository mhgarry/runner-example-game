...
class Cloud extends Phaser.GameObjects.Rectangle {
	constructor(scene, x, y) {
		...
		super(scene, x, finalY, 98, 32, 0xffffff); // extened the class using super and pass scene, x, finalY, width, height, and color as parameters to create the cloud object
	}
}
