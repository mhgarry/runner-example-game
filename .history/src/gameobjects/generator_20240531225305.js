...
class Cloud extends Phaser.GameObjects.Rectangle {
	constructor(scene, x, y) {
        ...
        scene.addExitsing(this); // add the cloud object to the scene
        scene alpha = 1 / Phaser.Math.Between(1, 3); // set the alpha of the cloud object to a random value between 1 and 3
	}
}
