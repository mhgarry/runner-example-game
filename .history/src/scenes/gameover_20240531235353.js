export default class GameOver extends Phaser.Scene {
	...
	create() {
		...
		this.center_width = this.width / 2; // set the center width property to half the width of the gameover scene
		this.center_height = this.height / 2; // set the center height property to half the height of the gameover scene
