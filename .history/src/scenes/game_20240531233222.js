    ...
    */
	...
	create() {
		...
		this.physics.add.overlap(
			...
			this,
        ); // add an overlap between the player and the coins to detect overlaps, call the collectCoin function when an overlap is detected using an anonymous function with the return value of true, and pass in the scene to the overlap method
